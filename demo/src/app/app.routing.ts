...
const routes: Routes = [
  ...
  {path: 'components/slider', component: NgbdSlider},
  {path: 'components/accordiontable', component: NgbdAccordiontable},
  {path: 'components/multiselect', component: NgbdMultiselect}
];
